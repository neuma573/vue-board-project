...
CREATE TABLE `LOGIN_LOG` (
  ...
  `LOG_ID` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL COMMENT '로그인 사용자',
  `LOG_TOKEN` varchar(15) COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '로그인토큰',
  `LOG_DT` datetime NOT NULL COMMENT '등록일시',
  `LOG_IS_AUTH_VALID` char(1) COLLATE utf8mb3_unicode_ci NOT NULL COMMENT '사용여부',
  PRIMARY KEY (`LOG_SEQ`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='로그인 로그';
